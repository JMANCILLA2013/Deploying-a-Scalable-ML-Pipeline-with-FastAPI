...
#         # filter to just the slice
#     data_slice = X[X[feature] == feature_value]
#     y_slice = y[X[feature] == feature_value]

#     # process (reuse encoders, so training=False)
#     X_slice, _, _, _ = process_data(
#         data_slice,
#         categorical_features=[],  # <- you’ll pass your actual categorical list here
#         label=None,
#         training=False,
#         encoder=None,
#         lb=None,
